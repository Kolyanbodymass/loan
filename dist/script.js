...
function (_Slider) {
  ...
  function MainSlider(btns, modNext, modPrev) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns, modNext, modPrev));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.modPrev.forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();
      ...
      this.modNext.forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$modNext = _ref.modNext,
      modNext = _ref$modNext === void 0 ? null : _ref$modNext,
      _ref$modPrev = _ref.modPrev,
      modPrev = _ref$modPrev === void 0 ? null : _ref$modPrev,
